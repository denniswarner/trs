...
function wagmp_map_4() {
  if(GBrowserIsCompatible()) {
    ...
    var address_0 = {
      street: '1129 Professional Park Drive',
      city: 'Pinellas Park',
      state: 'FL',
      zip: '33781',
      country: '',
      infowindow: 'default',
      infowindowtext: '<span style="font: 12px Verdana, Arial, Helvetica, sans-serif; color: black;"><strong>Address:</strong><br />1129 Professional Park Drive<br />Brandon, FL 33511</span>',
      full: '1129 Professional Park Drive, Brandon, FL, 33511',
      isdefault: true,
      addressType: 'address',
      loop: '',
      latitude: '',
    ...
    if (cacheReturn != "" || (address_0.addressType == "coordinates")) {
      ...
      if (point && !isNaN(latitude)) {
        wagmp_map_4_obj.addressFailed = false;
...
if('address_0' == 'address_0')
          ...
          wagmp_map_4_obj.points.push(point);
        } else {
        if (wagmp_map_4_obj.addressFailed) {
          map.setCenter(new GLatLng(30, -98), 3);
        }
        wagmp_map_4_obj.addressFailed = true;
      }
