...
function wagmp_map_1() {
  if(GBrowserIsCompatible()) {
    ...
    var address_0 = {
      street: '1826 N. Crystal Lake Dr',
      city: 'Lakeland',
      state: 'FL',
      zip: '33801',
      country: 'USA',
      infowindow: 'default',
      infowindowtext: '<span style="font: 12px Verdana, Arial, Helvetica, sans-serif; color: black;"><strong>Address:</strong><br />1826 N. Crystal Lake Dr<br />Lakeland, FL 33801 USA</span>',
      full: '1826 N. Crystal Lake Dr, Lakeland, FL, 33801, USA',
      isdefault: true,
      addressType: 'address',
      loop: '',
      latitude: '',
