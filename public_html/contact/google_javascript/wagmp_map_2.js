...
function wagmp_map_2() {
  if(GBrowserIsCompatible()) {
    ...
    var address_0 = {
      street: '6231 66th Street North',
      city: 'Pinellas Park',
      state: 'FL',
      zip: '33781',
      country: 'USA',
      infowindow: 'default',
      infowindowtext: '<span style="font: 12px Verdana, Arial, Helvetica, sans-serif; color: black;"><strong>Address:</strong><br />6231 66th Street North<br />Pinellas Park, FL 33781 USA</span>',
      full: '6231 66th Street North, Pinellas Park, FL, 33781, USA',
      isdefault: true,
      addressType: 'address',
      loop: '',
      latitude: '',
